const projects = [
  {
    ...
    tech: ["React", "Vite", "Express.js", "Node.js", "OpenAI GPT-3.5 Turbo", "OpenRouter API", "Tailwind CSS", "Vercel"],
  ...
  },
  {
    ...
    summary:
      "A comprehensive analytics dashboard built with React and Vercel Functions, providing real-time data visualization across Analytics, CRM, and E-commerce modules with responsive design and dark/light mode.",
    tech: [
      "React",
      "Vite",
      "React Router",
    ...
    details: [
      "Sneat is a full-stack analytics dashboard that demonstrates modern web development practices. Built with React and deployed on Vercel, it provides real-time data visualization across multiple business modules including Analytics, CRM, and E-commerce functionality.",
      ...
      "Highlights:",
      "- Full-stack architecture with React, Vercel Functions, and MongoDB Atlas",
